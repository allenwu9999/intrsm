...
void trsm4x4_kernel_1_1(
    ...
    for (int j = 0; j <= N - 4; j += 4) {
        ...
        // x1 = (b1 - i10*x0) / invA[1][1] = b1 * i11 (i10 = 0)
        __m256d x1 = _mm256_mul_pd(i11, b1);

        // x2 = (b2 - i20*x0 - i21*x1) / invA[2][2] = (b2 - i20*x0 - i21*x1) * i22
        __m256d t0 = _mm256_fnmadd_pd(i20, x0, _mm256_fnmadd_pd(i21, x1, b2));
        __m256d x2 = _mm256_mul_pd(i22, t0);

        // x3 = (b3 - i30*x0 - i31*x1 - i32*x2) / invA[3][3] = (b3 - i30*x0 - i31*x1 - i32*x2) * i33
        __m256d t1 = _mm256_fnmadd_pd(i30, x0, _mm256_fnmadd_pd(i31, x1, b3));
        __m256d x3 = _mm256_mul_pd(i33, _mm256_fnmadd_pd(i32, x2, t1));
